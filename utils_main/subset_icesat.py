# author: xin luo
# create: 2021.8.30; modify: 2022.9.25
# des: subset file with given extent, or mask image, or time range.

'''
example:
    python subset_icesat.py ./input/path/*.h5 -r 90 91 30 31 -t 2008.1 2008.4
    python subset_icesat.py ./input/path/*.h5 -m ./data/mask.tif -t 2008.1 2008.4
'''
...
def subset(ifile, extent=[None,None,None,None], time_range=[None, None], \
    ...
    if extent_mask[0] and vars_dict[lon_name].any():     
